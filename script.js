...
if (isEnglish) {
  ...
  const translations = {
    ...
    '2018年にYahoo! JAPANへ入社。主要メディアの大規模プロダクト開発・BCP、広告・マーケティング領域における1,000名超のエンジニアリング組織戦略と人材育成、技術研究室長を担当しました。その後、全社生成AI戦略と社内情報検索AIを推進し、10か月でMAU400％成長、10,000名超が利用する基盤へ拡大しました。': 'I joined Yahoo! JAPAN in 2018. My work included large-scale product development and business continuity for major media services, engineering strategy and talent development for an organization of more than 1,000 people in advertising and marketing, and leadership of Technology Research. I later advanced company-wide generative AI strategy and an internal AI search platform, which achieved 400% MAU growth in 10 months and scaled to more than 10,000 users.',
