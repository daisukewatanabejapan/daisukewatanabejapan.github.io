...
if (isEnglish) {
  ...
  const translations = {
    ...
    'AIを、社会で機能する': 'Engineering AI That Works',
    'エンジニアリングへ。': 'in the Real World.',
    '技術、プロダクト、組織を一体として捉え、大規模なAIの社会実装を前進させる。現場から経営までをつなぐエンジニアリングリーダーシップに取り組んでいます。': 'I bring technology, product, and organization together to advance AI implementation at scale, connecting engineering execution with executive leadership.',
    'SB OAI Japan合同会社　エンジニアリング本部長': 'SB OAI Japan GK — Head of Engineering',
    'ソフトバンク株式会社': 'SoftBank Corp.',
    '法人事業統括 SB OAI本部 エンジニアリング統括部長': 'Head of Engineering Division, SB OAI Division, Enterprise Business Unit',
    'メディア・検索ドメイン サイエンスSBU': 'Media & Search Domain, Science SBU',
    '現在のミッション': 'Current Mission',
    '企業・社会で継続的に価値を生むAIシステムの設計と実装': 'Designing and delivering AI systems that create sustained value for business and society.',
    '複数専門領域が協働する、強く健全な開発組織の構築': 'Building strong, healthy engineering organizations across multiple disciplines.',
    '経営と現場をつなぐ技術戦略、意思決定、人材育成': 'Connecting executives and engineering teams through technology strategy, decision-making, and leadership development.',
    'AIを企業・社会の実運用に組み込み、継続的な価値へつなげる': 'Embedding AI into real-world business and society to create sustained value.',
    '専門性を越えて協働し、持続的に成長する開発組織をつくる': 'Building engineering organizations that collaborate across disciplines and grow sustainably.',
    '技術・事業・組織をつなぎ、意思決定と実行を前進させる': 'Connecting technology, business, and organization to advance decisions and execution.',
    ...
    'Engineering Leaders Day 2026 キーノート': 'Engineering Leaders Day 2026 Keynote',
    'Engineering Leaders Day 2026公式ビジュアル': 'Official Engineering Leaders Day 2026 visual',
    'AI時代の開発組織とものづくり——SB OAI Japanのソフトウェア開発現場における実装と実践知': 'Engineering organizations and software development in the AI era — implementation and practical insights from SB OAI Japan’s engineering teams',
    'ファインディ株式会社': 'Findy Inc.',
    '2026年10月27日（火）': 'October 27, 2026',
