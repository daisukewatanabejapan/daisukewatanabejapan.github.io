...
if (isEnglish) {
  ...
  const translations = {
    ...
    'メディア・広告・検索・研究開発の各領域において、主要メディアの大規模プロダクト開発・BCP、技術戦略に携わるとともに、2,000名超のメディア・広告・マーケティング組織における1,000名超のエンジニアリング組織戦略とエンジニア人材育成を担当しました。Yahoo!検索および研究開発領域では、開発責任者として1,000名規模の組織を担当しました。': 'Worked across media, advertising, search, and R&D on large-scale product development and business continuity for major media services and technology strategy, while contributing to engineering organization strategy and engineering talent development for an engineering organization of more than 1,000 people within a media, advertising, and marketing organization of more than 2,000 people. In Yahoo! Search and R&D, served as an engineering leader responsible for an organization of approximately 1,000 people.',
