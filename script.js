...
if (isEnglish) {
  ...
  const translations = {
    ...
    '神戸高専電子工学科で半導体工学・ソフトウェア工学を学び、UNIX-Cプログラマーとしてキャリアをスタートしました。その後、日本テレビ放送網の番組Webサイトを8年間担当し、箱根駅伝・国政選挙速報システムの設計・開発・運用、読売新聞社のニュースメディア立ち上げに携わりました。さらに、上場企業の新規事業CTO、株式会社Gunosy執行役員・開発本部長として、事業開発とエンジニアリング組織づくりを担当しました。': 'After studying semiconductor and software engineering in the Department of Electronic Engineering at Kobe KOSEN, I began my career as a UNIX/C programmer. I later spent eight years working on Nippon Television program websites, including the design, development, and operation of the Hakone Ekiden and national election reporting systems, and contributed to the launch of Yomiuri Shimbun news services. I subsequently worked on business development and engineering organization building as CTO of a new business at a listed company and as Executive Officer and Head of Development at Gunosy Inc.',
    '2018年にYahoo! JAPANへ入社し、主要メディアの大規模プロダクト開発、広告・マーケティング領域における1,000名超のエンジニアリング組織戦略と人材育成、技術研究室長を担当しました。その後は、全社生成AI戦略と社内情報検索AIの企画・推進を担当し、10,000名超が利用する基盤づくりに携わりました。': 'I joined Yahoo! JAPAN in 2018. My work included large-scale product development for major media services, engineering strategy and talent development for an organization of more than 1,000 people in advertising and marketing, and leadership of Technology Research. I later contributed to company-wide generative AI strategy and the planning and advancement of an internal AI search platform used by more than 10,000 people.',
