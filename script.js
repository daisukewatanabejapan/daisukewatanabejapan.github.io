...
if (isEnglish) {
  ...
  const translations = {
    ...
    '神戸高専電子工学科で半導体工学・ソフトウェア工学を学び、UNIX-Cプログラマーとしてキャリアをスタートしました。日本テレビでは番組Webサイトを8年間担当し、箱根駅伝・国政選挙速報システムの設計・開発・運用、読売新聞社のニュースメディア立ち上げに携わりました。': 'After studying semiconductor and software engineering in the Department of Electronic Engineering at Kobe KOSEN, I began my career as a UNIX/C programmer. At Nippon Television, I spent eight years working on program websites, including the design, development, and operation of the Hakone Ekiden and national election reporting systems, and contributed to the launch of Yomiuri Shimbun news services.',
