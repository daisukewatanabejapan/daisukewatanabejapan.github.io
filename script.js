...
if (isEnglish) {
  ...
  const translations = {
    ...
    '神戸高専電子工学科で半導体工学・ソフトウェア工学を学び、UNIX-Cプログラマーとしてキャリアを始めました。その後、日本テレビ放送網の番組Webサイトにおけるプログラマー／プロジェクトマネジャーを8年間務め、箱根駅伝速報・衆参両院選挙速報システムの要件定義から設計、実装、運用までを一貫して担当。あわせて、読売新聞社の主要ニュースメディアの立ち上げにも携わりました。その後、上場企業の新規事業CTOおよびGunosy執行役員・開発本部長として、事業と開発組織づくりに携わりました。': 'After studying semiconductor engineering and software engineering in the Department of Electronic Engineering at Kobe KOSEN, I began my career as a UNIX/C programmer. I later spent eight years as a programmer and project manager for Nippon Television program websites, taking end-to-end responsibility for the real-time Hakone Ekiden and national election systems, from requirements and design through implementation and operations. I also contributed to the launch of major Yomiuri Shimbun news services. I subsequently worked on business and engineering organization development as CTO of a new business at a listed company and as Executive Officer and Head of Development at Gunosy.',
    ...
    '2025年にグループ内異動でソフトバンク株式会社へ参画しました。2026年より、ソフトバンクグループとOpenAIによる合弁会社SB OAI Japan合同会社のエンジニアリング本部長を務めています。また、大学・高専での教育、半導体人材育成、企業・行政・スタートアップへの技術・組織支援にも取り組んでいます。': 'I joined SoftBank Corp. through an internal group transfer in 2025. Since 2026, I have served as VP and Head of Engineering at SB OAI Japan, the joint venture between SoftBank Group and OpenAI. I also contribute to university and KOSEN education, semiconductor talent development, and technology and organizational initiatives with companies, government, and startups.',
