...
if (isEnglish) {
  ...
  const translations = {
    ...
    '法人事業統括 SB OAI本部 エンジニアリング統括部 統括部長': 'Enterprise Business Unit, SB OAI Division — General Manager, Engineering Division',
    'SB OAI本部 エンジニアリング統括部長': 'Head of Engineering Division, SB OAI Division',
    'エンジニアリング統括部長': 'Head of Engineering Division',
    'エンジニアリング統括部 統括部長': 'General Manager, Engineering Division',
    ...
    '人生は、最初から計画できたものではありませんでした。': 'Life was never something I could plan from the beginning.',
    '好きなことを続け、人との出会いを大切にし、その時々で必要とされることに向き合ってきました。振り返れば、一つひとつの経験や出会いが、思いがけない形で次の道につながっていたように思います。': 'I have continued doing what I care about, valued the people I have met, and responded to what each moment asked of me. Looking back, every experience and encounter seems to have opened the way to what came next, often in unexpected ways.',
    'うまくいかないときや、立ち止まることがあっても、それまで歩いてきた道が無駄になるわけではありません。': 'Even when things do not go well, or when we need to pause, the path already traveled is not wasted.',
    '好きなことを続け、人との出会いを大切にし、その時々で必要とされることに向き合ってきました。振り返れば、一つひとつの経験や出会いが、思いがけない形で次の道につながっていたように思います。うまくいかないときや、立ち止まることがあっても、それまで歩いてきた道が無駄になるわけではありません。': 'I have continued doing what I care about, valued the people I have met, and responded to what each moment asked of me. Looking back, every experience and encounter seems to have opened the way to what came next, often in unexpected ways. Even when things do not go well, or when we need to pause, the path already traveled is not wasted.',
    '自分の歩幅で学び続け、人を大切にしながら、目の前のことに誠実に取り組む。その積み重ねが、いつか自分らしい道になっていくのだと思います。': 'Continuing to learn at our own pace, valuing the people around us, and approaching what is in front of us with sincerity—over time, those choices become a path of our own.',
    ...
    '2018年にYahoo! JAPANへ入社し、主要メディアの大規模プロダクト開発に携わるとともに、2,000名超のメディア・広告・マーケティング組織における組織戦略とエンジニア人材育成を担当しました。Yahoo!検索および研究開発領域では、1,000名規模の組織の開発責任者を務めました。全社生成AI戦略と社内情報検索AIの企画・推進も担当し、10,000名超が利用する基盤づくりに携わりました。': 'I joined Yahoo! JAPAN in 2018, where I worked on large-scale product development for major media services and was responsible for organizational strategy and engineering talent development across a media, advertising, and marketing organization of more than 2,000 people. In Yahoo! Search and R&D, I served as the engineering leader responsible for an organization of approximately 1,000 people. I also worked on company-wide generative AI strategy and the planning and advancement of an internal AI search platform used by more than 10,000 employees.',
    '日本テレビでは番組Webサイトを8年間担当し、箱根駅伝・国政選挙速報システムの設計・開発・運用、読売新聞社のニュースメディア立ち上げに携わりました。': 'At Nippon Television, I spent eight years working on program websites, including the design, development, and operation of the Hakone Ekiden and national election reporting systems, and contributed to the launch of Yomiuri Shimbun news services.',
    '神戸高専電子工学科で半導体工学・ソフトウェア工学を学び、UNIX-Cプログラマーとして、通信・公共システムの開発からキャリアをスタートしました。': 'After studying semiconductor and software engineering in the Department of Electronic Engineering at Kobe KOSEN, I began my career as a UNIX/C programmer working on telecommunications and public-sector systems.',
    ...
    '「生成AI概論」特別講義': 'Special Lecture: Introduction to Generative AI',
    ...
    '東京都立産業技術高等専門学校「生成AI概論」特別講義': 'Special Lecture: Introduction to Generative AI at Tokyo Metropolitan College of Industrial Technology',
    ...
    'Crystal Intelligenceの導入・展開に向けた技術設計・開発・実装を担うとともに、FDE、TDL、SWE、AIエンジニアリング領域の技術戦略と開発組織を担当しています。': 'Responsible for technical design, development, and implementation for the deployment and expansion of Crystal Intelligence, as well as technology strategy and engineering organizations across FDE, TDL, SWE, and AI engineering.',
    'AIの社会実装': 'AI Implementation',
    'SB OAI Japan設立': 'Establishment of SB OAI Japan GK',
    'サービス解説': 'Service Overview',
    'グループASI戦略本部を兼務し、グループ横断のAIプロジェクトを推進するとともに、ソフトバンクとOpenAIによる合弁事業におけるAIエンジニアリング組織の責任者を務めています。': 'Concurrently serving in the Group ASI Strategy Division, I drive group-wide AI initiatives while leading the AI engineering organization for the joint venture between SoftBank and OpenAI.',
    ...
    'メディア・広告・検索・研究開発の各領域において、主要メディアの大規模プロダクト開発・BCP、技術戦略に携わるとともに、2,000名超のメディア・広告・マーケティング組織における組織戦略とエンジニア人材育成を担当しました。Yahoo!検索および研究開発領域では、1,000名規模の組織の開発責任者を務めました。': 'Worked across media, advertising, search, and R&D on large-scale product development and business continuity for major media services and technology strategy, while contributing to organizational strategy and engineering talent development within a media, advertising, and marketing organization of more than 2,000 people. In Yahoo! Search and R&D, served as the engineering leader responsible for an organization of approximately 1,000 people.',
    'CTO／VPoEキャリアトーク': 'CTO / VPoE Career Talk',
    'ヤフーDXセミナー': 'Yahoo Japan DX Seminar',
    '執行役員': 'Executive Officer',
    '開発本部長': 'Head of Development',
    'ニュースプロダクト・広告システムの設計・開発・運用、技術戦略、開発基盤の整備を担当するとともに、エンジニアリング組織づくりとエンジニア採用・育成に携わりました。': 'Worked on the design, development, and operation of news products and advertising systems, technology strategy, and development infrastructure, while also contributing to engineering organization development, hiring, and talent development.',
    ...
    '技術統括責任者': 'HEAD OF ENGINEERING',
    'ソーシャル事業本部': 'Social Business Division',
    'マネジャー': 'Manager',
    'モバイルキャリア公式サイト向けコンテンツ配信、ソーシャルアプリ、広告領域の開発・運営に加え、iPhone・iPad向けアプリ、電子書籍、新規事業の企画・開発に携わりました。': 'Led the development and operation of content delivery services for mobile carrier portals, social applications, and advertising platforms, while also working on iPhone and iPad applications, e-books, and the planning and development of new businesses.',
    ...
    'メディア': 'Media',
    '広告': 'Advertising',
    '広告・マーケティング': 'Advertising & Marketing',
    ...
    '組織・働き方': 'Engineering Leadership',
    'アジャイルコーチング': 'Agile Coaching',
    'エグゼクティブコーチング': 'Executive Coaching',
    'エンジニアリング組織設計': 'Engineering Organization Design',
    'これまでの経験を生かし、企業・教育機関・行政・公共団体において、次のような活動に取り組んでいます。': 'Drawing on my experience, I contribute to organizations, educational institutions, government bodies, and public organizations through the following activities.',
    'エンジニアリング組織づくり': 'Engineering organization development',
    'アジャイル組織変革': 'Agile organizational transformation',
    '技術顧問': 'Technical advisory',
    'エンジニア・技術リーダー育成': 'Engineering and technical leadership development',
    '講演・基調講演': 'Speaking and keynote presentations',
    '企業研修・ワークショップ': 'Corporate training and workshops',
    '高等教育・行政における人材育成': 'Leadership development in higher education and the public sector',
  ...
  const aboutCareerBusiness = document.querySelector('.about-career-business');
  if (aboutCareerBusiness) aboutCareerBusiness.textContent = 'I worked on business development and engineering organization building as CTO of a new business at a listed company and as Executive Officer and Head of Development at Gunosy Inc.';
  ...
  const attributeTranslations = {
    ...
    'Agile Coaches Alliance Japanコミュニティへの渡邊大輔参加紹介ビジュアル': 'Daisuke Watanabe — Agile Coaches Alliance Japan community introduction visual',
    ...
    'SB OAI JapanのAI社会実装インタビューに掲載された渡邊大輔': 'Daisuke Watanabe featured in the SB OAI Japan interview on real-world AI implementation',
    'SB OAI Japan インタビュー': 'SB OAI Japan Interview',
    'DX&AI Forum 2026 Fall 東京の登壇者と開催概要': 'Speakers and event details for DX&AI Forum 2026 Fall Tokyo',
