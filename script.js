...
if (isEnglish) {
  ...
  const translations = {
    ...
    '2025年にソフトバンク株式会社へ参画しました。2026年より、ソフトバンクグループとOpenAIによる合弁会社SB OAI Japan合同会社のエンジニアリング本部長を務めています。また、大学・高専での教育や半導体人材育成に加え、企業・行政における実践的なアジャイル組織づくり、AI・ソフトウェアエンジニアリング分野の技術支援、講演活動にも取り組んでいます。': 'I joined SoftBank Corp. in 2025. Since 2026, I have served as VP and Head of Engineering at SB OAI Japan GK, the joint venture between SoftBank Group and OpenAI. Alongside university and KOSEN education and semiconductor talent development, I contribute to practical agile organization building in companies and government, provide technical support in AI and software engineering, and engage in speaking activities.',
