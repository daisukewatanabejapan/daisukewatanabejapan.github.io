...
if (isEnglish) {
  ...
  const translations = {
    ...
    '神戸高専電子工学科で半導体工学・ソフトウェア工学を学び、UNIX-Cプログラマーとして、通信・公共領域のシステム開発からキャリアをスタートしました。日本テレビでは番組Webサイトを8年間担当し、箱根駅伝・国政選挙速報システムの設計・開発・運用、読売新聞社のニュースメディア立ち上げに携わりました。': 'After studying semiconductor and software engineering in the Department of Electronic Engineering at Kobe KOSEN, I began my career as a UNIX/C programmer working on telecommunications and public-sector systems. At Nippon Television, I spent eight years working on program websites, including the design, development, and operation of the Hakone Ekiden and national election reporting systems, and contributed to the launch of Yomiuri Shimbun news services.',
    'その後、上場企業の新規事業CTO、株式会社Gunosy執行役員・開発本部長として、事業開発とエンジニアリング組織づくりを担当しました。': 'I subsequently worked on business development and engineering organization building as CTO of a new business at a listed company and as Executive Officer and Head of Development at Gunosy Inc.',
    '2018年にYahoo! JAPANへ入社し、主要メディアの大規模プロダクト開発に携わるとともに、2,000名超のメディア・広告・マーケティング組織における組織戦略とエンジニア人材育成を担当しました。Yahoo!検索および研究開発領域では、1,000名規模の組織の開発責任者を務めました。その後は、全社生成AI戦略と社内情報検索AIの企画・推進を担当し、10,000名超が利用する基盤づくりに携わりました。': 'I joined Yahoo! JAPAN in 2018, where I worked on large-scale product development for major media services and was responsible for organizational strategy and engineering talent development across a media, advertising, and marketing organization of more than 2,000 people. In Yahoo! Search and R&D, I served as the engineering leader responsible for an organization of approximately 1,000 people. I later contributed to company-wide generative AI strategy and the planning and advancement of an internal AI search platform used by more than 10,000 employees.',
